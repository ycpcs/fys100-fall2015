...
Class meetings will consist primarily of hands-on activities and discussions: these will serve as a starting point for writing assignments and projects.
...
The [Writing Assignments](assign/index.html) and [Unit Projects](project/index.html) pages list the homework assignments.

Writing assignments are written essays in response to readings and course topics.

Unit projects are open-ended creative projects relating to the five units of the course: Visual Art, Music, Humanities, Sciences, and Society.

Unit projects will typically include both an in-class presentation and deliverables to be submitted electronically.
...
Repeated unexcused absences, or failure to participate in class activities, will reduce your participation grade.  I will consider 6 or more unexcused absences to be grounds for assign a failing grade for the course.
